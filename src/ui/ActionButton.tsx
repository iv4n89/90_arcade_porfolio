...
export const ActionButton: React.FC<ActionButtonProps> = ({
  ...
  const getButtonStyles = () => {
    switch (type) {
      ...
      case "close":
        return "px-4 py-2 border cursor-pointer border-gray-400 text-gray-400 font-mono text-sm rounded hover:border-gray-300 hover:text-gray-300 transition-all";
      default:
        return "";
    }
  };
